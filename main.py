...
with sync_playwright() as p:
  try:
    ...
    os.system("xvfb-run -a chromium --remote-debugging-port=9222 --no-sandbox --disable-gpu --disable-dev-shm-usage --disable-setuid-sandbox --disable-web-security --disable-features=IsolateOrigins,site-per-process &")
    sleep(10)
    browser = p.chromium.connect_over_cdp('http://localhost:9222')
